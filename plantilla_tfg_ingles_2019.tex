...
\setcounter{page}{3}
	...
	\textbf{Keywords: \acrlong{ved}, feature embeddings, multiclass and binary classification, \acrlong{nn}s}
...
\input{resources-and-methods-for-avd.tex}

\chapter{Our approach for Acoustic Violent Detection}
\input{our-approach-for-avd.tex}
...
\chapter{Planning and economic resources}
\input{planning-and-ec-resources.tex}
