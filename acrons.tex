...
\newacronym{avd}{AVD}{Acoustic Violent Detection}
\newacronym{ft}{FT}{Fourier Transform}
\newacronym{dft}{DFT}{Discrete Fourier Transform}
\newacronym{fft}{FFT}{Fast Fourier Transform}
\newacronym{bof}{BOF}{Bag-of-frames}
\newacronym{med}{MED}{Multimedia Event Detection}
\newacronym{sdg}{SDG}{Sustainable Development Goals}
\newacronym{un}{UN}{United Nations}
\newacronym{who}{WHO}{World Health Organization}
\newacronym{cc}{CC}{Classifier-Chains}
\newacronym{ved}{VED}{Violent Event Detection}